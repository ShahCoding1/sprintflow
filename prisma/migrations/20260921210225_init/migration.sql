...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_MENTIONED', 'TASK_COMMENTED', 'TASK_STATUS_CHANGED', 'SPRINT_STARTED', 'SPRINT_COMPLETED', 'PROJECT_INVITATION', 'ORGANIZATION_INVITATION', 'SYSTEM');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('CREATED', 'UPDATED', 'DELETED', 'ASSIGNED', 'UNASSIGNED', 'STATUS_CHANGED', 'PRIORITY_CHANGED', 'COMMENTED', 'MOVED', 'ADDED', 'REMOVED');
